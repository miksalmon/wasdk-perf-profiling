...
{
    thread_local UwpActivationSampleAppCpp::Logger Logger::s_loggerInstance{ nullptr };
    ...
    UwpActivationSampleAppCpp::Logger Logger::Singleton()
    {
        if (s_loggerInstance == nullptr)
        {
            s_loggerInstance = UwpActivationSampleAppCpp::Logger();
        }
