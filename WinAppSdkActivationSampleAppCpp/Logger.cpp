...
{
    thread_local WinAppSdkActivationSampleAppCpp::Logger Logger::s_loggerInstance{ nullptr };
    ...
    WinAppSdkActivationSampleAppCpp::Logger Logger::Singleton()
    {
        if (s_loggerInstance == nullptr)
        {
            s_loggerInstance = WinAppSdkActivationSampleAppCpp::Logger();
        }
